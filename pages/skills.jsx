...
const Skills = ({ handleChangePage }) => {
  ...
  return (
    <>
      ...
      <Box height="100%">
        <Box className={classes.divider} style={{ backgroundColor: colorShadow }} />
        <Box p={4}>
          <Grid container alignItems="flex-start" justify="center" spacing={2}>
              ...
              <Box display="flex" mt={2} justifyContent="center">
                ...
                <Tooltip title="Designer Skills" placement="top" arrow>
                  <Box
                    ...
                    mr={2}
                    className={
                      skillActive === 1 ? classes.designSkillsActive : classes.designSkills
                    }
                  >
            ...
            <Grid item xs={12} md={8} lg={8}>
              ...
              {skillActive === 1 && (
                <Grid container spacing={2}>
                  {designerSkills.map((design) => (
                    <Grid key={design.techologie} item xs={6} sm={4} md={4} lg={2}>
              ...
              {skillActive === 2 && (
                <Grid container spacing={2}>
                  {softSkills.map((soft) => (
                    <Grid key={soft.skill} item xs={12} sm={4} md={4} lg={4}>
                      <Zoom
                        timeout={500}
                        in={true}
                        disableStrictModeCompat
